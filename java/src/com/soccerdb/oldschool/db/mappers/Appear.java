...
public class Appear{
    ...
    public Appear(int player_id, int season_id, int game_id, Date start_time, Date end_time, String in_game_position, int goals, int assist, int save, int foul, int card, int distance) {
